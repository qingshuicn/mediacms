...
class AutoplayCountdownOverlay extends Component {
    ...
    createEl() {
        ...
        const nextVideoTitle = this.nextVideoData?.title || translateString('Next Video');

        overlay.innerHTML = `
            <button class="autoplay-close-button" aria-label="${translateString('Cancel autoplay')}" title="${translateString('Cancel')}">
            ...
            <div class="autoplay-countdown-content">
                <div class="countdown-label">${translateString('Up Next')}</div>
